          ...
          <div>
            ...
            <ul className="space-y-5 text-gray-400">
              <li className="flex items-start">
                <svg className="w-6 h-6 mr-4 mt-1 text-[#d32f2f] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path></svg>
                <span className="text-lg">120A McBride St,<br/>Brackenhurst, Alberton, SA</span>
              </li>
              <li className="flex items-center">
                <svg className="w-6 h-6 mr-4 text-[#d32f2f] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                <a href="mailto:tcc.bracken@gmail.com" className="text-lg hover:text-white transition-colors">tcc.bracken@gmail.com</a>
              </li>
              <li className="flex items-center">
                <svg className="w-6 h-6 mr-4 text-[#d32f2f] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                <a href="tel:0825580141" className="text-lg font-bold text-white hover:text-red-400 transition-colors">082 558 0141</a>
              </li>
            </ul>

            {/* Social Links closely positioned with Contact Details */}
            <div className="mt-6 pt-6 border-t border-white/10">
              <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-3">Connect With Us</p>
              <div className="flex flex-wrap items-center gap-3">
                <a 
                  href="https://www.facebook.com/search/top?q=transformation%20city%20church" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 px-4 py-2.5 bg-[#1877F2] hover:bg-blue-600 text-white rounded-xl text-xs font-bold transition-all transform hover:scale-105 shadow-md"
                  title="Transformation City Church on Facebook"
                  aria-label="Facebook"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 px-4 py-2.5 bg-gradient-to-tr from-amber-500 via-pink-600 to-purple-600 hover:opacity-95 text-white rounded-xl text-xs font-bold transition-all transform hover:scale-105 shadow-md"
                  title="Transformation City Church on Instagram"
